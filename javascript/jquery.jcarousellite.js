...
(function($) {
	$.fn.bindGdlTestimonial = function() {
		var carousellite = $(this);
		var fetch_num = carousellite.find('ul').children().length;
		carousellite.parent(".columns, .column").css('overflow', 'hidden');
		carousellite.jCarouselLite({ btnNext: ".next", btnPrev: ".prev", visible: fetch_num });
	}
